...
class IntermidiatePracticePage extends StatefulWidget {
  final CameraDescription camera;
  const IntermidiatePracticePage({Key? key, required this.camera}) : super(key: key);

  @override
  State<IntermidiatePracticePage> createState() => _PracticePageState();
}

class _PracticePageState extends State<IntermidiatePracticePage> {
